...
from mapclientplugins.savetriangulatedobjectstep.ui_configuredialog import Ui_ConfigureDialog
import os.path
...
class ConfigureDialog(QtGui.QDialog):
    ...
    def _outputLocationButtonClicked(self):
        location = QtGui.QFileDialog.getExistingDirectory(self, caption='Select Directory', dir = self._previousLocation)
        if location:
            self._previousLocation = location
            self._ui.lineEdit1.setText(location)
    ...
    def validate(self):
        ...
        validDir = os.path.exists(self._ui.lineEdit1.text())
        if os.path.exists(self._ui.lineEdit1.text()):
    ...
    def getConfig(self):
        ...
        config['Output directory'] = self._ui.lineEdit1.text()
        config['Filename'] = self._ui.lineEdit2.text()
        return config
    ...
    def setConfig(self, config):
        ...
        self._ui.lineEdit1.setText(config['Output directory'])
        self._ui.lineEdit2.setText(config['Filename'])
